...
var app = express();
var port = 7800 || process.env.PORT ||7800;
var bodParser = require('body-parser');
var mongo = require('mongodb');
var MongoClient = mongo.MongoClient
var mongourl = "mongodb+srv://newuser_14:mubii1234@cluster0.let4b.mongodb.net/zomato?retryWrites=true&w=majority";
...
app.get('/restaurants',(req,res) => {
    ...
    db.collection('datas').find(condition).toArray((err,result) => {
        if(err) throw err;
        res.send(result)
    })
})
...
app.get('/restaurantdetails/:id',(req,res) => {
    ...
    db.collection('datas').find(query).toArray((err,result) => {
        res.send(result)
    })
})
